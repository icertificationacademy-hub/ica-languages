...
import { MessageCircle, MapPin, Clock, Monitor, Users, GraduationCap, Smile, Handshake } from "lucide-react";
import { siteConfig } from "@/data/site";

export const metadata: Metadata = {
  title: "Únete al Equipo | ICA Languages",
  description:
    "Explora nuestras vacantes para profesores de idiomas. ICA Languages, Apizaco Tlaxcala.",
};
...
const vacancies = [
  {
    ...
    ubicacion: "Av Juárez 412, Centro, 90300 Cdad. de Apizaco, Tlax.",
    horario: "9:00 a.m a 2:00 pm",
    extra: "Trabajo presencial en instalaciones.",
      ...
      <section className="relative overflow-hidden bg-white pt-28 pb-0">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pb-20 relative z-10">
          <span className="inline-flex items-center gap-2 bg-violet-50 text-violet-700 text-sm font-semibold px-4 py-1.5 rounded-full mb-5 border border-violet-100 shadow-sm">
            <Handshake className="w-4 h-4" /> Trabaja con nosotros
          </span>
          <h1
          ...
          <p className="text-xl font-semibold text-slate-700 mb-3">
            Explora nuestras vacantes para profesores
          </p>
          <p className="text-base text-slate-500 leading-relaxed max-w-2xl mx-auto">
            En ICA Languages, valoramos la pasión por la enseñanza y el crecimiento continuo. Únete a una comunidad vibrante dedicada a conectar el mundo a través de los idiomas.
          </p>
        </div>
